...
export type SeatPlanElementType =
  | "COLUMN"
  | "COUCH"
  | "DOOR"
  | "ENTRANCE"
...
export type ResolversTypes = {
  ...
  SeatPlan: ResolverTypeWrapper<
    Omit<SeatPlan, "elements"> & {
      elements: Array<ResolversTypes["SeatPlanElement"]>;
    }
  >;
  SeatPlanElement: ResolverTypeWrapper<
    Omit<SeatPlanElement, "type"> & {
      type: ResolversTypes["SeatPlanElementType"];
    }
  >;
  SeatPlanElementType: ResolverTypeWrapper<
    | "TABLE"
    | "ENTRANCE"
    | "EXIT"
    | "DOOR"
...
export type ResolversParentTypes = {
  ...
  SeatPlan: Omit<SeatPlan, "elements"> & {
    elements: Array<ResolversParentTypes["SeatPlanElement"]>;
  };
  SeatPlanElement: SeatPlanElement;
...
export type SeatPlanResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["SeatPlan"] = ResolversParentTypes["SeatPlan"],
> = {
  elements?: Resolver<
    Array<ResolversTypes["SeatPlanElement"]>,
    ParentType,
    ContextType
  >;
...
export type SeatPlanElementResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["SeatPlanElement"] = ResolversParentTypes["SeatPlanElement"],
> = {
  height?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  label?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  type?: Resolver<
    ResolversTypes["SeatPlanElementType"],
    ParentType,
    ContextType
  >;
  width?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
...
export type SeatPlanElementTypeResolvers = EnumResolverSignature<
  {
    COLUMN?: any;
    COUCH?: any;
    DOOR?: any;
...
export type Resolvers<ContextType = Context> = {
  ...
  SeatPlanElement?: SeatPlanElementResolvers<ContextType>;
  SeatPlanElementType?: SeatPlanElementTypeResolvers;

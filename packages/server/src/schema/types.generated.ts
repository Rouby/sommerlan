...
import { BeerPongMatchMapper, BeerPongTournamentMapper } from './beerPong/schema.mappers';
...
export type ResolversTypes = {
  ...
  BeerPongGroup: ResolverTypeWrapper<Omit<BeerPongGroup, 'matches' | 'teams'> & { matches: Array<ResolversTypes['BeerPongMatch']>, teams: Array<ResolversTypes['BeerPongGroupStanding']> }>;
  BeerPongGroupStanding: ResolverTypeWrapper<Omit<BeerPongGroupStanding, 'team'> & { team: ResolversTypes['BeerPongTeam'] }>;
  Int: ResolverTypeWrapper<Scalars['Int']['output']>;
  BeerPongKnockoutRound: ResolverTypeWrapper<Omit<BeerPongKnockoutRound, 'matches'> & { matches: Array<ResolversTypes['BeerPongMatch']> }>;
  BeerPongMatch: ResolverTypeWrapper<BeerPongMatchMapper>;
  BeerPongMatchPhase: ResolverTypeWrapper<'EXHIBITION' | 'GROUP' | 'KNOCKOUT'>;
  BeerPongMatchTeam: ResolverTypeWrapper<Omit<BeerPongMatchTeam, 'team'> & { team?: Maybe<ResolversTypes['BeerPongTeam']> }>;
  BeerPongMatchTeamResultInput: BeerPongMatchTeamResultInput;
  BeerPongPlayerStats: ResolverTypeWrapper<Omit<BeerPongPlayerStats, 'user'> & { user: ResolversTypes['User'] }>;
  BeerPongPlayerStatsInput: BeerPongPlayerStatsInput;
  BeerPongTeam: ResolverTypeWrapper<Omit<BeerPongTeam, 'players'> & { players: Array<ResolversTypes['User']> }>;
  ...
  Purchase: ResolverTypeWrapper<Omit<Purchase, 'proposer' | 'status' | 'userVote' | 'votes'> & { proposer: ResolversTypes['User'], status: ResolversTypes['PurchaseStatus'], userVote?: Maybe<ResolversTypes['PurchaseVote']>, votes: Array<ResolversTypes['PurchaseVote']> }>;
  PurchaseStatus: ResolverTypeWrapper<'PROPOSED' | 'APPROVED' | 'REJECTED' | 'COMPLETED'>;
  PurchaseVote: ResolverTypeWrapper<Omit<PurchaseVote, 'user' | 'vote'> & { user: ResolversTypes['User'], vote: ResolversTypes['VoteValue'] }>;
  ...
  SeatPlan: ResolverTypeWrapper<Omit<SeatPlan, 'seats'> & { seats: Array<ResolversTypes['SeatPlanSeat']> }>;
  SeatPlanSeat: ResolverTypeWrapper<Omit<SeatPlanSeat, 'section'> & { section: ResolversTypes['SeatSection'] }>;
  SeatSection: ResolverTypeWrapper<'ISLAND' | 'MAIN'>;
...
export type ResolversParentTypes = {
  ...
  BeerPongGroup: Omit<BeerPongGroup, 'matches' | 'teams'> & { matches: Array<ResolversParentTypes['BeerPongMatch']>, teams: Array<ResolversParentTypes['BeerPongGroupStanding']> };
  BeerPongGroupStanding: Omit<BeerPongGroupStanding, 'team'> & { team: ResolversParentTypes['BeerPongTeam'] };
  Int: Scalars['Int']['output'];
  BeerPongKnockoutRound: Omit<BeerPongKnockoutRound, 'matches'> & { matches: Array<ResolversParentTypes['BeerPongMatch']> };
  BeerPongMatch: BeerPongMatchMapper;
  BeerPongMatchTeam: Omit<BeerPongMatchTeam, 'team'> & { team?: Maybe<ResolversParentTypes['BeerPongTeam']> };
  BeerPongMatchTeamResultInput: BeerPongMatchTeamResultInput;
  BeerPongPlayerStats: Omit<BeerPongPlayerStats, 'user'> & { user: ResolversParentTypes['User'] };
  BeerPongPlayerStatsInput: BeerPongPlayerStatsInput;
  BeerPongTeam: Omit<BeerPongTeam, 'players'> & { players: Array<ResolversParentTypes['User']> };
  BeerPongTeamInput: BeerPongTeamInput;
  ...
  PictureTagInput: PictureTagInput;
  ProfileInput: ProfileInput;
  Purchase: Omit<Purchase, 'proposer' | 'userVote' | 'votes'> & { proposer: ResolversParentTypes['User'], userVote?: Maybe<ResolversParentTypes['PurchaseVote']>, votes: Array<ResolversParentTypes['PurchaseVote']> };
  PurchaseVote: Omit<PurchaseVote, 'user'> & { user: ResolversParentTypes['User'] };
  Query: {};
  ...
  SeatPlan: Omit<SeatPlan, 'seats'> & { seats: Array<ResolversParentTypes['SeatPlanSeat']> };
  SeatPlanSeat: SeatPlanSeat;
...
export type rbacDirectiveResolver<Result, Parent, ContextType = Context, Args = rbacDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type AttendingResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Attending'] = ResolversParentTypes['Attending']> = {
  ...
  checkIn?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  checkOut?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  ...
  notificationSent?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  ...
  seatNumber?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type BeerPongGroupResolvers<ContextType = Context, ParentType extends ResolversParentTypes['BeerPongGroup'] = ResolversParentTypes['BeerPongGroup']> = {
  matches?: Resolver<Array<ResolversTypes['BeerPongMatch']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  teams?: Resolver<Array<ResolversTypes['BeerPongGroupStanding']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BeerPongGroupStandingResolvers<ContextType = Context, ParentType extends ResolversParentTypes['BeerPongGroupStanding'] = ResolversParentTypes['BeerPongGroupStanding']> = {
...
export type BeerPongKnockoutRoundResolvers<ContextType = Context, ParentType extends ResolversParentTypes['BeerPongKnockoutRound'] = ResolversParentTypes['BeerPongKnockoutRound']> = {
  matches?: Resolver<Array<ResolversTypes['BeerPongMatch']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type BeerPongMatchResolvers<ContextType = Context, ParentType extends ResolversParentTypes['BeerPongMatch'] = ResolversParentTypes['BeerPongMatch']> = {
  ...
  phase?: Resolver<ResolversTypes['BeerPongMatchPhase'], ParentType, ContextType>;
  players?: Resolver<Array<ResolversTypes['BeerPongPlayerStats']>, ParentType, ContextType>;
  round?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  startedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  teams?: Resolver<Array<ResolversTypes['BeerPongMatchTeam']>, ParentType, ContextType>;
  winner?: Resolver<Maybe<ResolversTypes['BeerPongTeam']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BeerPongMatchPhaseResolvers = EnumResolverSignature<{ EXHIBITION?: any, GROUP?: any, KNOCKOUT?: any }, ResolversTypes['BeerPongMatchPhase']>;

export type BeerPongMatchTeamResolvers<ContextType = Context, ParentType extends ResolversParentTypes['BeerPongMatchTeam'] = ResolversParentTypes['BeerPongMatchTeam']> = {
  ...
  team?: Resolver<Maybe<ResolversTypes['BeerPongTeam']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BeerPongPlayerStatsResolvers<ContextType = Context, ParentType extends ResolversParentTypes['BeerPongPlayerStats'] = ResolversParentTypes['BeerPongPlayerStats']> = {
...
export type BeerPongTeamResolvers<ContextType = Context, ParentType extends ResolversParentTypes['BeerPongTeam'] = ResolversParentTypes['BeerPongTeam']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type BeerPongTournamentResolvers<ContextType = Context, ParentType extends ResolversParentTypes['BeerPongTournament'] = ResolversParentTypes['BeerPongTournament']> = {
  groupCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  groups?: Resolver<Array<ResolversTypes['BeerPongGroup']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  knockout?: Resolver<Array<ResolversTypes['BeerPongKnockoutRound']>, ParentType, ContextType>;
  knockoutSize?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  matches?: Resolver<Array<ResolversTypes['BeerPongMatch']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  teams?: Resolver<Array<ResolversTypes['BeerPongTeam']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CacheEntryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CacheEntry'] = ResolversParentTypes['CacheEntry']> = {
  patches?: Resolver<Array<ResolversTypes['CachePatch']>, ParentType, ContextType>;
  sheet?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CacheInfoResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CacheInfo'] = ResolversParentTypes['CacheInfo']> = {
  entries?: Resolver<Array<ResolversTypes['CacheEntry']>, ParentType, ContextType>;
  lastSync?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CachePatchResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CachePatch'] = ResolversParentTypes['CachePatch']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type DonationDedicationResolvers = EnumResolverSignature<{ RENT?: any, WARCHEST?: any }, ResolversTypes['DonationDedication']>;
...
export type MoneyTransferResolvers<ContextType = Context, ParentType extends ResolversParentTypes['MoneyTransfer'] = ResolversParentTypes['MoneyTransfer']> = {
  amount?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type MutationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  capturePayPalOrder?: Resolver<Maybe<ResolversTypes['Attending']>, ParentType, ContextType, RequireFields<MutationcapturePayPalOrderArgs, 'orderId'>>;
  checkIn?: Resolver<Maybe<ResolversTypes['Attending']>, ParentType, ContextType, RequireFields<MutationcheckInArgs, 'userId'>>;
  checkOut?: Resolver<Maybe<ResolversTypes['Attending']>, ParentType, ContextType, RequireFields<MutationcheckOutArgs, 'userId'>>;
  createBeerPongMatch?: Resolver<ResolversTypes['BeerPongMatch'], ParentType, ContextType, RequireFields<MutationcreateBeerPongMatchArgs, 'playerIds'>>;
  createMoneyTransfer?: Resolver<ResolversTypes['MoneyTransfer'], ParentType, ContextType, RequireFields<MutationcreateMoneyTransferArgs, 'input'>>;
  createPayPalOrder?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  createPurchase?: Resolver<ResolversTypes['Purchase'], ParentType, ContextType, RequireFields<MutationcreatePurchaseArgs, 'description' | 'estimatedCost' | 'title'>>;
  deleteAuthDevice?: Resolver<ResolversTypes['AuthDevice'], ParentType, ContextType, RequireFields<MutationdeleteAuthDeviceArgs, 'id'>>;
  deleteBeerPongMatch?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationdeleteBeerPongMatchArgs, 'matchId'>>;
  ...
  endBeerPongMatch?: Resolver<ResolversTypes['BeerPongMatch'], ParentType, ContextType, RequireFields<MutationendBeerPongMatchArgs, 'matchId' | 'winnerTeamId'>>;
  generateBeerPongGroupStage?: Resolver<ResolversTypes['BeerPongTournament'], ParentType, ContextType, RequireFields<MutationgenerateBeerPongGroupStageArgs, 'tournamentId'>>;
  generateBeerPongKnockoutStage?: Resolver<ResolversTypes['BeerPongTournament'], ParentType, ContextType, RequireFields<MutationgenerateBeerPongKnockoutStageArgs, 'tournamentId'>>;
  ...
  removeProfilePicture?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  ...
  sendPaymentNotification?: Resolver<ResolversTypes['Attending'], ParentType, ContextType, RequireFields<MutationsendPaymentNotificationArgs, 'userId'>>;
  sendPaymentNotificationToAll?: Resolver<Array<ResolversTypes['Attending']>, ParentType, ContextType>;
  ...
  updateAttending?: Resolver<ResolversTypes['Attending'], ParentType, ContextType, RequireFields<MutationupdateAttendingArgs, 'input' | 'partyId'>>;
  ...
  updateBeerPongMatch?: Resolver<ResolversTypes['BeerPongMatch'], ParentType, ContextType, RequireFields<MutationupdateBeerPongMatchArgs, 'input'>>;
  updateBeerPongPlayerStats?: Resolver<ResolversTypes['BeerPongMatch'], ParentType, ContextType, RequireFields<MutationupdateBeerPongPlayerStatsArgs, 'input' | 'matchId'>>;
  updateGame?: Resolver<ResolversTypes['Game'], ParentType, ContextType, RequireFields<MutationupdateGameArgs, 'input'>>;
  updateLocation?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationupdateLocationArgs, 'latitude' | 'longitude'>>;
  updatePaidDues?: Resolver<Maybe<ResolversTypes['Attending']>, ParentType, ContextType, RequireFields<MutationupdatePaidDuesArgs, 'attendingId' | 'paidDues'>>;
  ...
  updatePurchaseStatus?: Resolver<ResolversTypes['Purchase'], ParentType, ContextType, RequireFields<MutationupdatePurchaseStatusArgs, 'purchaseId' | 'status'>>;
  updateRoles?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationupdateRolesArgs, 'id' | 'roles'>>;
  upsertBeerPongTournament?: Resolver<ResolversTypes['BeerPongTournament'], ParentType, ContextType, RequireFields<MutationupsertBeerPongTournamentArgs, 'input'>>;
  voteOnPurchase?: Resolver<ResolversTypes['Purchase'], ParentType, ContextType, RequireFields<MutationvoteOnPurchaseArgs, 'purchaseId' | 'vote'>>;
};

export type PartyResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Party'] = ResolversParentTypes['Party']> = {
  attending?: Resolver<Maybe<ResolversTypes['Attending']>, ParentType, ContextType, Partial<PartyattendingArgs>>;
  ...
  registrationDeadline?: Resolver<Maybe<ResolversTypes['Date']>, ParentType, ContextType>;
...
export type PurchaseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Purchase'] = ResolversParentTypes['Purchase']> = {
  ...
  userVote?: Resolver<Maybe<ResolversTypes['PurchaseVote']>, ParentType, ContextType>;
  voteCount?: Resolver<ResolversTypes['VoteCount'], ParentType, ContextType>;
  votes?: Resolver<Array<ResolversTypes['PurchaseVote']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PurchaseStatusResolvers = EnumResolverSignature<{ APPROVED?: any, COMPLETED?: any, PROPOSED?: any, REJECTED?: any }, ResolversTypes['PurchaseStatus']>;

export type PurchaseVoteResolvers<ContextType = Context, ParentType extends ResolversParentTypes['PurchaseVote'] = ResolversParentTypes['PurchaseVote']> = {
  createdAt?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  user?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  beerPongMatches?: Resolver<Array<ResolversTypes['BeerPongMatch']>, ParentType, ContextType>;
  beerPongTournament?: Resolver<Maybe<ResolversTypes['BeerPongTournament']>, ParentType, ContextType>;
  games?: Resolver<Array<ResolversTypes['Game']>, ParentType, ContextType>;
  getCacheInfo?: Resolver<Maybe<ResolversTypes['CacheInfo']>, ParentType, ContextType>;
  me?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  moneyTransfers?: Resolver<Array<ResolversTypes['MoneyTransfer']>, ParentType, ContextType>;
...
export type RoleResolvers = EnumResolverSignature<{ Admin?: any, Bookkeeper?: any, Doorkeeper?: any, Trusted?: any }, ResolversTypes['Role']>;

export type RoomStatusResolvers = EnumResolverSignature<{ GRANTED?: any, REQUESTED?: any }, ResolversTypes['RoomStatus']>;

export type SeatPlanResolvers<ContextType = Context, ParentType extends ResolversParentTypes['SeatPlan'] = ResolversParentTypes['SeatPlan']> = {
  numCols?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  numRows?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  seats?: Resolver<Array<ResolversTypes['SeatPlanSeat']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SeatPlanSeatResolvers<ContextType = Context, ParentType extends ResolversParentTypes['SeatPlanSeat'] = ResolversParentTypes['SeatPlanSeat']> = {
  col?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  label?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  row?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  section?: Resolver<ResolversTypes['SeatSection'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SeatSectionResolvers = EnumResolverSignature<{ ISLAND?: any, MAIN?: any }, ResolversTypes['SeatSection']>;
...
export type UserResolvers<ContextType = Context, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lastKnownLocation?: Resolver<Maybe<ResolversTypes['Location']>, ParentType, ContextType>;
...
export type VoteCountResolvers<ContextType = Context, ParentType extends ResolversParentTypes['VoteCount'] = ResolversParentTypes['VoteCount']> = {
...
export type VoteValueResolvers = EnumResolverSignature<{ ABSTAIN?: any, NO?: any, YES?: any }, ResolversTypes['VoteValue']>;
...
export type Resolvers<ContextType = Context> = {
  ...
  SeatPlan?: SeatPlanResolvers<ContextType>;
  SeatPlanSeat?: SeatPlanSeatResolvers<ContextType>;
  SeatSection?: SeatSectionResolvers;

...
import    { SeatPlan } from './party/resolvers/SeatPlan';
import    { SeatPlanSeat } from './party/resolvers/SeatPlanSeat';
...
import    { DateResolver,DateTimeResolver,JSONResolver,JWTResolver,TimeResolver } from 'graphql-scalars';
    export const resolvers: Resolvers = {
      Query: { beerPongMatches: Query_beerPongMatches,beerPongTournament: Query_beerPongTournament,games: Query_games,getCacheInfo: Query_getCacheInfo,me: Query_me,moneyTransfers: Query_moneyTransfers,nextParty: Query_nextParty,parties: Query_parties,party: Query_party,purchase: Query_purchase,purchases: Query_purchases,users: Query_users },
      Mutation: { addGameToParty: Mutation_addGameToParty,addPicture: Mutation_addPicture,capturePayPalOrder: Mutation_capturePayPalOrder,checkIn: Mutation_checkIn,checkOut: Mutation_checkOut,createBeerPongMatch: Mutation_createBeerPongMatch,createMoneyTransfer: Mutation_createMoneyTransfer,createPayPalOrder: Mutation_createPayPalOrder,createPurchase: Mutation_createPurchase,deleteAuthDevice: Mutation_deleteAuthDevice,deleteBeerPongMatch: Mutation_deleteBeerPongMatch,denyRoom: Mutation_denyRoom,donate: Mutation_donate,endBeerPongMatch: Mutation_endBeerPongMatch,generateBeerPongGroupStage: Mutation_generateBeerPongGroupStage,generateBeerPongKnockoutStage: Mutation_generateBeerPongKnockoutStage,generatePasskeyLoginOptions: Mutation_generatePasskeyLoginOptions,generatePasskeyRegisterOptions: Mutation_generatePasskeyRegisterOptions,grantRoom: Mutation_grantRoom,leaveEvent: Mutation_leaveEvent,loginMagicLink: Mutation_loginMagicLink,loginPasskey: Mutation_loginPasskey,loginPassword: Mutation_loginPassword,participateInEvent: Mutation_participateInEvent,planEvent: Mutation_planEvent,recindRoom: Mutation_recindRoom,refreshLogin: Mutation_refreshLogin,register: Mutation_register,registerPasskey: Mutation_registerPasskey,removeAttendance: Mutation_removeAttendance,removeProfilePicture: Mutation_removeProfilePicture,requestRoom: Mutation_requestRoom,rescindDonation: Mutation_rescindDonation,sendMagicLink: Mutation_sendMagicLink,sendPaymentNotification: Mutation_sendPaymentNotification,sendPaymentNotificationToAll: Mutation_sendPaymentNotificationToAll,setAttendance: Mutation_setAttendance,setGamesPlayed: Mutation_setGamesPlayed,syncCache: Mutation_syncCache,updateAttending: Mutation_updateAttending,updateAuthDevice: Mutation_updateAuthDevice,updateBeerPongMatch: Mutation_updateBeerPongMatch,updateBeerPongPlayerStats: Mutation_updateBeerPongPlayerStats,updateGame: Mutation_updateGame,updateLocation: Mutation_updateLocation,updatePaidDues: Mutation_updatePaidDues,updateParty: Mutation_updateParty,updateProfile: Mutation_updateProfile,updatePurchaseStatus: Mutation_updatePurchaseStatus,updateRoles: Mutation_updateRoles,upsertBeerPongTournament: Mutation_upsertBeerPongTournament,voteOnPurchase: Mutation_voteOnPurchase },

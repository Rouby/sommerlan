        ...
        },
        {
          ...
          type: {
            ...
            name: {
              kind: "Name",
              value: "File",
              loc: { start: 4520, end: 4524 },
            },
            loc: { start: 4520, end: 4524 },
          },
          directives: [],
          loc: { start: 4512, end: 4524 },
        },
      ],
      loc: { start: 4424, end: 4526 },
    },
    {
      kind: "ObjectTypeDefinition",
      name: {
      ...
      fields: [
        {
          kind: "FieldDefinition",
          name: { kind: "Name", value: "id", loc: { start: 4548, end: 4550 } },
          arguments: [],
          type: {
            kind: "NonNullType",
            type: {
              ...
              name: {
                kind: "Name",
                value: "ID",
                loc: { start: 4552, end: 4554 },
              },
              loc: { start: 4552, end: 4554 },
            },
            loc: { start: 4552, end: 4555 },
          },
          directives: [],
          loc: { start: 4548, end: 4555 },
        },
        {
          kind: "FieldDefinition",
          name: {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: "Name",
                value: "String",
                loc: { start: 4564, end: 4570 },
              },
              loc: { start: 4564, end: 4570 },
            },
            loc: { start: 4564, end: 4571 },
          },
          directives: [],
          loc: { start: 4558, end: 4571 },
        },
        {
          kind: "FieldDefinition",
          name: {
          ...
          type: {
            ...
            name: {
              kind: "Name",
              value: "DateTime",
              loc: { start: 4585, end: 4593 },
            },
            loc: { start: 4585, end: 4593 },
          },
          directives: [],
          loc: { start: 4574, end: 4593 },
        },
        {
          kind: "FieldDefinition",
          name: {
          ...
          type: {
            ...
            name: {
              kind: "Name",
              value: "DateTime",
              loc: { start: 4608, end: 4616 },
            },
            loc: { start: 4608, end: 4616 },
          },
          directives: [],
          loc: { start: 4596, end: 4616 },
        },
      ],
      loc: { start: 4528, end: 4618 },
    },
  ],
  loc: { start: 0, end: 4619 },

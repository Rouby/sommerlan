...
export type PartySeatPlanQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, seatsAvailable: number, tentative: boolean, registrationDeadline?: any | null, attendings: Array<{ __typename?: 'Attending', id: string, seatNumber?: string | null, withPc?: boolean | null, dates: Array<any>, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> } | null };

...
export type PartyPaymentInfoQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, finalCostPerDay?: number | null, payday?: any | null, attendings: Array<{ __typename?: 'Attending', id: string, dates: Array<any>, paidDues: number, user: { __typename?: 'User', id: string, displayName: string } }>, donations: Array<{ __typename?: 'Donation', id: string, amount: number, dedication: DonationDedication, donator?: { __typename?: 'User', id: string } | null }> } | null };

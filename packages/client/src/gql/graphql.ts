...
export enum BeerPongMatchPhase {
...
export type SeatPlan = {
  __typename?: 'SeatPlan';
  elements: Array<SeatPlanElement>;
  height: Scalars['Float']['output'];
  width: Scalars['Float']['output'];
};

export type SeatPlanElement = {
  __typename?: 'SeatPlanElement';
  height: Scalars['Float']['output'];
  id: Scalars['ID']['output'];
  label?: Maybe<Scalars['String']['output']>;
  type: SeatPlanElementType;
  width: Scalars['Float']['output'];
  x: Scalars['Float']['output'];
  y: Scalars['Float']['output'];
};

export enum SeatPlanElementType {
  Column = 'COLUMN',
  Couch = 'COUCH',
  Door = 'DOOR',
  Entrance = 'ENTRANCE',
...
export type SetAttendanceMutation = { __typename?: 'Mutation', setAttendance: { __typename?: 'Party', id: string, rentalCostPerDay: number, billableDaysCount: number, dayBreakdown: Array<{ __typename?: 'PartyDayBreakdown', date: string, isBillable: boolean, rentalCost: number, participantsCount: number, costPerParticipant: number }>, attendings: Array<{ __typename?: 'Attending', id: string, dates: Array<any>, rentDues?: number | null, feedingDues?: number | null }> } };
...
export type BeerPongTournamentAdminQueryVariables = Exact<{ [key: string]: never; }>;


export type BeerPongTournamentAdminQuery = { __typename?: 'Query', beerPongTournament?: { __typename?: 'BeerPongTournament', id: string, name: string, groupCount: number, knockoutSize: number, teams: Array<{ __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> }>, groups: Array<{ __typename?: 'BeerPongGroup', name: string, teams: Array<{ __typename?: 'BeerPongGroupStanding', rank: number, matches: number, wins: number, losses: number, remainingBeers: number, remainingBeerDiff: number, team: { __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> } }>, matches: Array<{ __typename?: 'BeerPongMatch', id: string, startedAt: any, endedAt?: any | null, phase: BeerPongMatchPhase, groupName?: string | null, round: number, matchNumber: number, winner?: { __typename?: 'BeerPongTeam', id: string } | null, teams: Array<{ __typename?: 'BeerPongMatchTeam', slotLabel: string, remainingBeers: number, isWinner: boolean, team?: { __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> } | null }>, players: Array<{ __typename?: 'BeerPongPlayerStats', hits: number, edges: number, blocks: number, throws: number, bounceHits: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> }> }>, knockout: Array<{ __typename?: 'BeerPongKnockoutRound', round: number, name: string, matches: Array<{ __typename?: 'BeerPongMatch', id: string, startedAt: any, endedAt?: any | null, phase: BeerPongMatchPhase, groupName?: string | null, round: number, matchNumber: number, winner?: { __typename?: 'BeerPongTeam', id: string } | null, teams: Array<{ __typename?: 'BeerPongMatchTeam', slotLabel: string, remainingBeers: number, isWinner: boolean, team?: { __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> } | null }>, players: Array<{ __typename?: 'BeerPongPlayerStats', hits: number, edges: number, blocks: number, throws: number, bounceHits: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> }> }>, matches: Array<{ __typename?: 'BeerPongMatch', id: string, startedAt: any, endedAt?: any | null, phase: BeerPongMatchPhase, groupName?: string | null, round: number, matchNumber: number, winner?: { __typename?: 'BeerPongTeam', id: string } | null, teams: Array<{ __typename?: 'BeerPongMatchTeam', slotLabel: string, remainingBeers: number, isWinner: boolean, team?: { __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> } | null }>, players: Array<{ __typename?: 'BeerPongPlayerStats', hits: number, edges: number, blocks: number, throws: number, bounceHits: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> }> } | null, users: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> };

export type UpsertBeerPongTournamentMutationVariables = Exact<{
  input: UpsertBeerPongTournamentInput;
}>;


export type UpsertBeerPongTournamentMutation = { __typename?: 'Mutation', upsertBeerPongTournament: { __typename?: 'BeerPongTournament', id: string } };

export type GenerateBeerPongGroupStageMutationVariables = Exact<{
  tournamentId: Scalars['ID']['input'];
}>;


export type GenerateBeerPongGroupStageMutation = { __typename?: 'Mutation', generateBeerPongGroupStage: { __typename?: 'BeerPongTournament', id: string } };

export type GenerateBeerPongKnockoutStageMutationVariables = Exact<{
  tournamentId: Scalars['ID']['input'];
}>;


export type GenerateBeerPongKnockoutStageMutation = { __typename?: 'Mutation', generateBeerPongKnockoutStage: { __typename?: 'BeerPongTournament', id: string } };

export type UpdateBeerPongMatchMutationVariables = Exact<{
  input: UpdateBeerPongMatchInput;
}>;


export type UpdateBeerPongMatchMutation = { __typename?: 'Mutation', updateBeerPongMatch: { __typename?: 'BeerPongMatch', id: string, endedAt?: any | null } };
...
export type CreateMoneyTransferMutationVariables = Exact<{
  input: CreateMoneyTransferInput;
}>;


export type CreateMoneyTransferMutation = { __typename?: 'Mutation', createMoneyTransfer: { __typename?: 'MoneyTransfer', id: string, amount: number, valuationDate: any, note?: string | null, correlationId?: string | null } };
...
export type NextPartyBudgetQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, donations: Array<{ __typename?: 'Donation', id: string, amount: number, dedication: DonationDedication, donator?: { __typename?: 'User', id: string, displayName: string, avatar: string } | null }>, attendings: Array<{ __typename?: 'Attending', id: string, dates: Array<any>, rentDues?: number | null, feedingDues?: number | null, paidDues: number, notificationSent?: any | null, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> } | null };
...
export type BeerPongTournamentPublicQueryVariables = Exact<{ [key: string]: never; }>;


export type BeerPongTournamentPublicQuery = { __typename?: 'Query', beerPongTournament?: { __typename?: 'BeerPongTournament', id: string, name: string, groups: Array<{ __typename?: 'BeerPongGroup', name: string, teams: Array<{ __typename?: 'BeerPongGroupStanding', rank: number, matches: number, wins: number, losses: number, remainingBeers: number, remainingBeerDiff: number, team: { __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> } }>, matches: Array<{ __typename?: 'BeerPongMatch', id: string, startedAt: any, endedAt?: any | null, phase: BeerPongMatchPhase, groupName?: string | null, round: number, matchNumber: number, teams: Array<{ __typename?: 'BeerPongMatchTeam', slotLabel: string, remainingBeers: number, isWinner: boolean, team?: { __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> } | null }>, players: Array<{ __typename?: 'BeerPongPlayerStats', hits: number, edges: number, blocks: number, throws: number, bounceHits: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> }> }>, knockout: Array<{ __typename?: 'BeerPongKnockoutRound', round: number, name: string, matches: Array<{ __typename?: 'BeerPongMatch', id: string, startedAt: any, endedAt?: any | null, phase: BeerPongMatchPhase, groupName?: string | null, round: number, matchNumber: number, teams: Array<{ __typename?: 'BeerPongMatchTeam', slotLabel: string, remainingBeers: number, isWinner: boolean, team?: { __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> } | null }>, players: Array<{ __typename?: 'BeerPongPlayerStats', hits: number, edges: number, blocks: number, throws: number, bounceHits: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> }> }>, matches: Array<{ __typename?: 'BeerPongMatch', id: string, startedAt: any, endedAt?: any | null, phase: BeerPongMatchPhase, groupName?: string | null, round: number, matchNumber: number, teams: Array<{ __typename?: 'BeerPongMatchTeam', slotLabel: string, remainingBeers: number, isWinner: boolean, team?: { __typename?: 'BeerPongTeam', id: string, name: string, seed: number, players: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }> } | null }>, players: Array<{ __typename?: 'BeerPongPlayerStats', hits: number, edges: number, blocks: number, throws: number, bounceHits: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> }> } | null };
...
export type SetMyOrOtherAttendanceMutation = { __typename?: 'Mutation', setAttendance: { __typename?: 'Party', id: string, rentalCostPerDay: number, billableDaysCount: number, dayBreakdown: Array<{ __typename?: 'PartyDayBreakdown', date: string, isBillable: boolean, rentalCost: number, participantsCount: number, costPerParticipant: number }>, attendings: Array<{ __typename?: 'Attending', id: string, dates: Array<any>, rentDues?: number | null, feedingDues?: number | null }> } };
...
export type RemoveAttendanceMutation = { __typename?: 'Mutation', removeAttendance: { __typename?: 'Party', id: string, rentalCostPerDay: number, billableDaysCount: number, dayBreakdown: Array<{ __typename?: 'PartyDayBreakdown', date: string, isBillable: boolean, rentalCost: number, participantsCount: number, costPerParticipant: number }>, attendings: Array<{ __typename?: 'Attending', id: string, dates: Array<any>, rentDues?: number | null, feedingDues?: number | null }> } };

export type UpdateMyAttendingMutationVariables = Exact<{
  partyId: Scalars['ID']['input'];
  input: UpdateAttendingInput;
}>;


export type UpdateMyAttendingMutation = { __typename?: 'Mutation', updateAttending: { __typename?: 'Attending', id: string, withPc?: boolean | null, seatNumber?: string | null } };
...
export type NextPartyCostsQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, tentative: boolean, rentalCosts: number, feedingCosts: number, paidDues?: number | null, payday?: any | null, rentalCostPerDay: number, billableDaysCount: number, dayBreakdown: Array<{ __typename?: 'PartyDayBreakdown', date: string, isBillable: boolean, rentalCost: number, participantsCount: number, costPerParticipant: number }>, donations: Array<{ __typename?: 'Donation', id: string, amount: number, dedication: DonationDedication, donator?: { __typename?: 'User', id: string, displayName: string, avatar: string } | null }>, attendings: Array<{ __typename?: 'Attending', id: string, dates: Array<any>, paidDues: number, rentDues?: number | null, feedingDues?: number | null, user: { __typename?: 'User', id: string } }> } | null };
...
export type PartyEventsInfoFragment = { __typename?: 'Party', id: string, startDate: any, endDate: any, events: Array<{ __typename: 'Event', id: string, image: string, date?: any | null, startTime?: string | null, endTime?: string | null, name: string, description?: string | null, eventType: EventType, pricingMode?: EventPricingMode | null, price?: number | null, servingsUnit?: string | null, totalServings: number, organizer: { __typename?: 'User', id: string, displayName: string, avatar: string }, participants: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }>, participantServings: Array<{ __typename?: 'EventParticipant', servings: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> }> } & { ' $fragmentName'?: 'PartyEventsInfoFragment' };
...
export type ToggleEventParticipationMutation = { __typename?: 'Mutation', participateInEvent?: { __typename?: 'Event', id: string, totalServings: number, participants: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }>, participantServings: Array<{ __typename?: 'EventParticipant', servings: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> }, leaveEvent?: { __typename?: 'Event', id: string, totalServings: number, participants: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }>, participantServings: Array<{ __typename?: 'EventParticipant', servings: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> } };

export type UpdateEventServingsMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  servings: Scalars['Int']['input'];
  userId?: InputMaybe<Scalars['ID']['input']>;
}>;
...
export type UpdateEventServingsMutation = { __typename?: 'Mutation', updateEventServings: { __typename?: 'Event', id: string, totalServings: number, participants: Array<{ __typename?: 'User', id: string, displayName: string, avatar: string }>, participantServings: Array<{ __typename?: 'EventParticipant', servings: number, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> } };
...
export type PartyPaymentInfoQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, payday?: any | null, attendings: Array<{ __typename?: 'Attending', id: string, dates: Array<any>, rentDues?: number | null, feedingDues?: number | null, paidDues: number, user: { __typename?: 'User', id: string, displayName: string } }>, donations: Array<{ __typename?: 'Donation', id: string, amount: number, dedication: DonationDedication, donator?: { __typename?: 'User', id: string } | null }> } | null };
...
export type PartySeatPlanQueryVariables = Exact<{ [key: string]: never; }>;


export type PartySeatPlanQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, tentative: boolean, registrationDeadline?: any | null, seatPlan: { __typename?: 'SeatPlan', width: number, height: number, elements: Array<{ __typename?: 'SeatPlanElement', id: string, type: SeatPlanElementType, x: number, y: number, width: number, height: number, label?: string | null }> }, attendings: Array<{ __typename?: 'Attending', id: string, seatNumber?: string | null, withPc?: boolean | null, dates: Array<any>, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> } | null };

export type SetSeatPreferenceMutationVariables = Exact<{
  partyId: Scalars['ID']['input'];
  input: UpdateAttendingInput;
}>;


export type SetSeatPreferenceMutation = { __typename?: 'Mutation', updateAttending: { __typename?: 'Attending', id: string, seatNumber?: string | null } };
...
export type VoteOnPurchaseMutation = { __typename?: 'Mutation', voteOnPurchase: { __typename?: 'Purchase', id: string, voteCount: { __typename?: 'VoteCount', yes: number, no: number, abstain: number }, userVote?: { __typename?: 'PurchaseVote', vote: VoteValue, user: { __typename?: 'User', id: string } } | null } };

export type UpdatePurchaseStatusMutationVariables = Exact<{
  purchaseId: Scalars['ID']['input'];
  status: PurchaseStatus;
}>;


export type UpdatePurchaseStatusMutation = { __typename?: 'Mutation', updatePurchaseStatus: { __typename?: 'Purchase', id: string, status: PurchaseStatus } };
...
export type AdminPartyQueryVariables = Exact<{ [key: string]: never; }>;


export type AdminPartyQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, startDate: any, endDate: any, location: string, locationWidgetSrc?: string | null, roomsAvailable: number, tentative: boolean, rentalCosts: number, feedingCosts: number, registrationDeadline?: any | null, payday?: any | null } | null, parties: Array<{ __typename?: 'Party', id: string, startDate: any, endDate: any, location: string, locationWidgetSrc?: string | null, roomsAvailable: number, tentative: boolean, rentalCosts: number, feedingCosts: number, registrationDeadline?: any | null, payday?: any | null }> };
...
export const BeerPongTournamentAdminDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"beerPongTournamentAdmin"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"beerPongTournament"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"groupCount"}},{"kind":"Field","name":{"kind":"Name","value":"knockoutSize"}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"groups"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rank"}},{"kind":"Field","name":{"kind":"Name","value":"matches"}},{"kind":"Field","name":{"kind":"Name","value":"wins"}},{"kind":"Field","name":{"kind":"Name","value":"losses"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeers"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeerDiff"}},{"kind":"Field","name":{"kind":"Name","value":"team"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"matches"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"phase"}},{"kind":"Field","name":{"kind":"Name","value":"groupName"}},{"kind":"Field","name":{"kind":"Name","value":"round"}},{"kind":"Field","name":{"kind":"Name","value":"matchNumber"}},{"kind":"Field","name":{"kind":"Name","value":"winner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slotLabel"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeers"}},{"kind":"Field","name":{"kind":"Name","value":"isWinner"}},{"kind":"Field","name":{"kind":"Name","value":"team"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"hits"}},{"kind":"Field","name":{"kind":"Name","value":"edges"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"}},{"kind":"Field","name":{"kind":"Name","value":"throws"}},{"kind":"Field","name":{"kind":"Name","value":"bounceHits"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"knockout"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"round"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"matches"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"phase"}},{"kind":"Field","name":{"kind":"Name","value":"groupName"}},{"kind":"Field","name":{"kind":"Name","value":"round"}},{"kind":"Field","name":{"kind":"Name","value":"matchNumber"}},{"kind":"Field","name":{"kind":"Name","value":"winner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slotLabel"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeers"}},{"kind":"Field","name":{"kind":"Name","value":"isWinner"}},{"kind":"Field","name":{"kind":"Name","value":"team"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"hits"}},{"kind":"Field","name":{"kind":"Name","value":"edges"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"}},{"kind":"Field","name":{"kind":"Name","value":"throws"}},{"kind":"Field","name":{"kind":"Name","value":"bounceHits"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"matches"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"phase"}},{"kind":"Field","name":{"kind":"Name","value":"groupName"}},{"kind":"Field","name":{"kind":"Name","value":"round"}},{"kind":"Field","name":{"kind":"Name","value":"matchNumber"}},{"kind":"Field","name":{"kind":"Name","value":"winner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slotLabel"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeers"}},{"kind":"Field","name":{"kind":"Name","value":"isWinner"}},{"kind":"Field","name":{"kind":"Name","value":"team"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"hits"}},{"kind":"Field","name":{"kind":"Name","value":"edges"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"}},{"kind":"Field","name":{"kind":"Name","value":"throws"}},{"kind":"Field","name":{"kind":"Name","value":"bounceHits"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"users"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]} as unknown as DocumentNode<BeerPongTournamentAdminQuery, BeerPongTournamentAdminQueryVariables>;
export const UpsertBeerPongTournamentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"upsertBeerPongTournament"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpsertBeerPongTournamentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"upsertBeerPongTournament"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<UpsertBeerPongTournamentMutation, UpsertBeerPongTournamentMutationVariables>;
export const GenerateBeerPongGroupStageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"generateBeerPongGroupStage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tournamentId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"generateBeerPongGroupStage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tournamentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tournamentId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<GenerateBeerPongGroupStageMutation, GenerateBeerPongGroupStageMutationVariables>;
export const GenerateBeerPongKnockoutStageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"generateBeerPongKnockoutStage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tournamentId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"generateBeerPongKnockoutStage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"tournamentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tournamentId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<GenerateBeerPongKnockoutStageMutation, GenerateBeerPongKnockoutStageMutationVariables>;
export const UpdateBeerPongMatchDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"updateBeerPongMatch"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateBeerPongMatchInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateBeerPongMatch"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}}]}}]}}]} as unknown as DocumentNode<UpdateBeerPongMatchMutation, UpdateBeerPongMatchMutationVariables>;
...
export const BeerPongTournamentPublicDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"beerPongTournamentPublic"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"beerPongTournament"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"groups"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rank"}},{"kind":"Field","name":{"kind":"Name","value":"matches"}},{"kind":"Field","name":{"kind":"Name","value":"wins"}},{"kind":"Field","name":{"kind":"Name","value":"losses"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeers"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeerDiff"}},{"kind":"Field","name":{"kind":"Name","value":"team"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"matches"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"phase"}},{"kind":"Field","name":{"kind":"Name","value":"groupName"}},{"kind":"Field","name":{"kind":"Name","value":"round"}},{"kind":"Field","name":{"kind":"Name","value":"matchNumber"}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slotLabel"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeers"}},{"kind":"Field","name":{"kind":"Name","value":"isWinner"}},{"kind":"Field","name":{"kind":"Name","value":"team"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"hits"}},{"kind":"Field","name":{"kind":"Name","value":"edges"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"}},{"kind":"Field","name":{"kind":"Name","value":"throws"}},{"kind":"Field","name":{"kind":"Name","value":"bounceHits"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"knockout"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"round"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"matches"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"phase"}},{"kind":"Field","name":{"kind":"Name","value":"groupName"}},{"kind":"Field","name":{"kind":"Name","value":"round"}},{"kind":"Field","name":{"kind":"Name","value":"matchNumber"}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slotLabel"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeers"}},{"kind":"Field","name":{"kind":"Name","value":"isWinner"}},{"kind":"Field","name":{"kind":"Name","value":"team"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"hits"}},{"kind":"Field","name":{"kind":"Name","value":"edges"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"}},{"kind":"Field","name":{"kind":"Name","value":"throws"}},{"kind":"Field","name":{"kind":"Name","value":"bounceHits"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"matches"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"endedAt"}},{"kind":"Field","name":{"kind":"Name","value":"phase"}},{"kind":"Field","name":{"kind":"Name","value":"groupName"}},{"kind":"Field","name":{"kind":"Name","value":"round"}},{"kind":"Field","name":{"kind":"Name","value":"matchNumber"}},{"kind":"Field","name":{"kind":"Name","value":"teams"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slotLabel"}},{"kind":"Field","name":{"kind":"Name","value":"remainingBeers"}},{"kind":"Field","name":{"kind":"Name","value":"isWinner"}},{"kind":"Field","name":{"kind":"Name","value":"team"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"seed"}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"players"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"hits"}},{"kind":"Field","name":{"kind":"Name","value":"edges"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"}},{"kind":"Field","name":{"kind":"Name","value":"throws"}},{"kind":"Field","name":{"kind":"Name","value":"bounceHits"}}]}}]}}]}}]}}]} as unknown as DocumentNode<BeerPongTournamentPublicQuery, BeerPongTournamentPublicQueryVariables>;
...
export const UpdateMyAttendingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"updateMyAttending"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"partyId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateAttendingInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateAttending"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"partyId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"partyId"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"withPc"}},{"kind":"Field","name":{"kind":"Name","value":"seatNumber"}}]}}]}}]} as unknown as DocumentNode<UpdateMyAttendingMutation, UpdateMyAttendingMutationVariables>;
...
export const ToggleEventParticipationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"toggleEventParticipation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"participate"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"servings"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"participateInEvent"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"userId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}},{"kind":"Argument","name":{"kind":"Name","value":"servings"},"value":{"kind":"Variable","name":{"kind":"Name","value":"servings"}}}],"directives":[{"kind":"Directive","name":{"kind":"Name","value":"include"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"participate"}}}]}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"totalServings"}},{"kind":"Field","name":{"kind":"Name","value":"participants"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"participantServings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"servings"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"leaveEvent"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"userId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}],"directives":[{"kind":"Directive","name":{"kind":"Name","value":"skip"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"participate"}}}]}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"totalServings"}},{"kind":"Field","name":{"kind":"Name","value":"participants"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"participantServings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"servings"}}]}}]}}]}}]} as unknown as DocumentNode<ToggleEventParticipationMutation, ToggleEventParticipationMutationVariables>;
export const UpdateEventServingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"updateEventServings"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"servings"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateEventServings"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"servings"},"value":{"kind":"Variable","name":{"kind":"Name","value":"servings"}}},{"kind":"Argument","name":{"kind":"Name","value":"userId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"totalServings"}},{"kind":"Field","name":{"kind":"Name","value":"participants"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"participantServings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}},{"kind":"Field","name":{"kind":"Name","value":"servings"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateEventServingsMutation, UpdateEventServingsMutationVariables>;
...
export const PartySeatPlanDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"partySeatPlan"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nextParty"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"tentative"}},{"kind":"Field","name":{"kind":"Name","value":"registrationDeadline"}},{"kind":"Field","name":{"kind":"Name","value":"seatPlan"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}},{"kind":"Field","name":{"kind":"Name","value":"elements"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"x"}},{"kind":"Field","name":{"kind":"Name","value":"y"}},{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}},{"kind":"Field","name":{"kind":"Name","value":"label"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"attendings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"seatNumber"}},{"kind":"Field","name":{"kind":"Name","value":"withPc"}},{"kind":"Field","name":{"kind":"Name","value":"dates"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"avatar"}}]}}]}}]}}]}}]} as unknown as DocumentNode<PartySeatPlanQuery, PartySeatPlanQueryVariables>;
export const SetSeatPreferenceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"setSeatPreference"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"partyId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateAttendingInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateAttending"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"partyId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"partyId"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"seatNumber"}}]}}]}}]} as unknown as DocumentNode<SetSeatPreferenceMutation, SetSeatPreferenceMutationVariables>;
...
export const UpdatePurchaseStatusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"updatePurchaseStatus"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"purchaseId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PurchaseStatus"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updatePurchaseStatus"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"purchaseId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"purchaseId"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<UpdatePurchaseStatusMutation, UpdatePurchaseStatusMutationVariables>;
...
export const AdminPartyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"adminParty"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nextParty"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"location"}},{"kind":"Field","name":{"kind":"Name","value":"locationWidgetSrc"}},{"kind":"Field","name":{"kind":"Name","value":"roomsAvailable"}},{"kind":"Field","name":{"kind":"Name","value":"tentative"}},{"kind":"Field","name":{"kind":"Name","value":"rentalCosts"}},{"kind":"Field","name":{"kind":"Name","value":"feedingCosts"}},{"kind":"Field","name":{"kind":"Name","value":"registrationDeadline"}},{"kind":"Field","name":{"kind":"Name","value":"payday"}}]}},{"kind":"Field","name":{"kind":"Name","value":"parties"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"location"}},{"kind":"Field","name":{"kind":"Name","value":"locationWidgetSrc"}},{"kind":"Field","name":{"kind":"Name","value":"roomsAvailable"}},{"kind":"Field","name":{"kind":"Name","value":"tentative"}},{"kind":"Field","name":{"kind":"Name","value":"rentalCosts"}},{"kind":"Field","name":{"kind":"Name","value":"feedingCosts"}},{"kind":"Field","name":{"kind":"Name","value":"registrationDeadline"}},{"kind":"Field","name":{"kind":"Name","value":"payday"}}]}}]}}]} as unknown as DocumentNode<AdminPartyQuery, AdminPartyQueryVariables>;
export const AdminUpdatePartyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"adminUpdateParty"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PartyInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateParty"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"location"}},{"kind":"Field","name":{"kind":"Name","value":"locationWidgetSrc"}},{"kind":"Field","name":{"kind":"Name","value":"roomsAvailable"}},{"kind":"Field","name":{"kind":"Name","value":"tentative"}},{"kind":"Field","name":{"kind":"Name","value":"rentalCosts"}},{"kind":"Field","name":{"kind":"Name","value":"feedingCosts"}},{"kind":"Field","name":{"kind":"Name","value":"registrationDeadline"}},{"kind":"Field","name":{"kind":"Name","value":"payday"}}]}}]}}]} as unknown as DocumentNode<AdminUpdatePartyMutation, AdminUpdatePartyMutationVariables>;
...
export type PartyAttendingInfoFragment = { __typename?: 'Party', id: string, startDate: any, endDate: any, roomsAvailable: number, attendings: Array<{ __typename?: 'Attending', id: string, dates: Array<any>, room?: RoomStatus | null, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> } & { ' $fragmentName'?: 'PartyAttendingInfoFragment' };

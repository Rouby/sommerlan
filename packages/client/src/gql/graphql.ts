...
export type NextPartyDonationsQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, registrationDeadline?: any | null, donations: Array<{ __typename: 'Donation', id: string, amount: number, dedication: DonationDedication, received: boolean, donator?: { __typename?: 'User', id: string, displayName: string, avatar: string } | null }> } | null };

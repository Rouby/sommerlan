...
export type PartySeatPlanQuery = { __typename?: 'Query', nextParty?: { __typename?: 'Party', id: string, tentative: boolean, registrationDeadline?: any | null, seatPlan: { __typename?: 'SeatPlan', numRows: number, numCols: number, seats: Array<{ __typename?: 'SeatPlanSeat', id: string, label: string, row: number, col: number, section: SeatSection }> }, attendings: Array<{ __typename?: 'Attending', id: string, seatNumber?: string | null, withPc?: boolean | null, dates: Array<any>, user: { __typename?: 'User', id: string, displayName: string, avatar: string } }> } | null };
